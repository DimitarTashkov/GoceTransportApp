...
namespace GoceTransportApp.Data.Migrations
{
    ...
    [Migration("20260408215146_AddOrganizationTrialEmailFlags")]
    partial class AddOrganizationTrialEmailFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.Organization", b =>
                {
                    ...
                    b.Property<bool>("TrialDay2EmailSent")
                        .HasColumnType("bit");

                    b.Property<bool>("TrialDay7EmailSent")
                        .HasColumnType("bit");

                    b.Property<bool>("TrialExpiredEmailSent")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("TrialExpiresOn")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.Route", b =>
                {
                    ...
                    b.Property<string>("FromStopName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.RouteStop", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.Notification", b =>
                {
                    b.HasOne("GoceTransportApp.Data.Models.ApplicationUser", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("GoceTransportApp.Data.Models.Review", b =>
                {
                    ...
                    b.HasOne("GoceTransportApp.Data.Models.ApplicationUser", "Passenger")
                        .WithMany()
